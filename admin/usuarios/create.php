            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
    <form action="<?= APP_URL ?>/app/controllers/usuarios/create.php" method="POST" id="form-registrar-rol">
    <div class="row">
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <input type="password" name="repetir_password" id="repetir_password" class="form-control" placeholder="Repita Password" required>
    </div>
</div>
